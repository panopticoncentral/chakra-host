...
Namespace Hosting
    ...
    Public Structure JavaScriptRuntime
        ...
        Public Shared Function Create(attributes As JavaScriptRuntimeAttributes, threadServiceCallback As JavaScriptThreadServiceCallback) As JavaScriptRuntime
        ...
        ''' <param name="attributes">The attributes of the runtime to be created.</param>
        ''' <returns>The runtime created.</returns>
        Public Shared Function Create(attributes As JavaScriptRuntimeAttributes) As JavaScriptRuntime
            Return Create(attributes, Nothing)
        End Function
        ...
        Public Shared Function Create() As JavaScriptRuntime
            Return Create(JavaScriptRuntimeAttributes.None, Nothing)
        End Function
